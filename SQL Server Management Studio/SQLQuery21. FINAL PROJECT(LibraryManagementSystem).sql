         ...
         /*Creating database db_finalproject */
		...
		CREATE PROCEDURE createShockWaveDB
        AS
		 BEGIN
		...
		/* Adding foreign keys to BOOK_COPIES,BOOK_LOANS,BOOKS and BOOK_AUTHORS */
            ...
            /*Using database to return all book titles and the authors name*/
			   ...
			   SELECT 
				...
				SELECT
					  b1.Number_Of_Copies, d1.Title, a1.BranchName
					  FROM 
