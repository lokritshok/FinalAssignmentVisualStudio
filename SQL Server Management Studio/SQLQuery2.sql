...
INSERT INTO tbl_habitat
	   ...
	   ('jungle vines and windy branches', 15000),
	   ('clive with shaded cave', 15000)
;
...
IF EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.TABLES tbl_species)
   DROP TABLE tbl_species, tbl_anamilia, tbl_care, tbl_class, tbl_habitat, tbl_nutrition, tbl_order, tbl_specialist;
